...
final Settings settings = Settings(
    ...
    appId: appId.readAsStringSync(), measure: Measure.imperial);
...
void appDataclassMethods() {
  group('App Dataclass Methods', () {
    ...
    test('App.fromMap() and ==', () {
      ...
      expect(app.toString(), expectation.toString());
    });
...
void dietDataclassMethods() {
  group('Diet Dataclass Methods', () {
    test('Diet.toString()', () {
      String expectation =
          'Diet(name: ${diet.name}, days: ${diet.days}, dris: ${diet.dris}, shoppingList: ${diet.shoppingList})';
    ...
    test('Diet.fromMap() and ==', () {
      ...
      expect(diet.toString(), expectation.toString());
    });
...
void dietTests() {
  group('Diet Tests', () {
    ...
    test('Diet.getShoppingList', () {
      ...
      expect(
          dc_eq.equals(result.map((e) => [e.name, e.grams]).toList(), [
            ['pizza', 240],
            ['No Sugar Keto Cup, Dark Chocolate', 50],
            ['milk', 100]
          ]),
          true);
    });
