                ...
                children: [
                      ...
                      Flexible(
                        child: BlocBuilder<InitSettingsBloc, InitSettingsState>(
                          builder: (context, state) {
                            return TextFormField(
                                onChanged: (val){
                                    context.read<InitSettingsBloc>()
                                        .add(WeightUpdate(val));

                                    context.read<InitSettingsBloc>().add(
                                        KgUpdate(val));

                                },
                                decoration: InputDecoration(
                                  errorText: state.errorWeight || state.errorKg
                  ...
                  Row(
                    children: [
                      ...
                      Flexible(child: BlocBuilder<InitSettingsBloc,
                          InitSettingsState>(
                        builder: (context, state) {
                          return TextFormField(
                            decoration: InputDecoration(
                  ...
                  ElevatedButton(onPressed: () {
                    context.read<InitSettingsBloc>().add(SubmitInitSettings());
