...
List<ReflectedClass> dataclasses = [
  ReflectedClass(
      ...
      methods: [
        ...
        Method.create(
            ...
            false,
            null),
        Method.create('updateMeal', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        ...
        Method.create('deleteDiet', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('renameDiet', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('reorderDiet', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('updateSettings', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
  ...
  ReflectedClass(
      ...
      methods: [
        Method.create('create', ReflectedType.create(Future, 'Future<Diet>'),
            MethodType.normal, true, null, false, Diet.create),
        Method.create('createDay', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('removeDay', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('refreshDays', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('reorderDay', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('duplicateDay', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create(
            'initShoppingList',
        ...
        Method.create('updateShoppingList', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('updateDRIS', ReflectedType.create(dynamic, 'dynamic'),
            MethodType.normal, false, null, false, null),
  ...
  ReflectedClass(
      ...
      methods: [
        Method.create('id', ReflectedType.create(int, 'int'), MethodType.normal,
            false, null, false, null),
        Method.create('addDayMeal', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('addDayMealFromIng', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        ...
        Method.create(
            ...
            false,
            null),
        Method.create('reorderMeal', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
        Method.create('replaceMealInDay', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
  ...
  ReflectedClass(
      ...
      getters: [
        Getter.create(ReflectedType.create(int, 'int'), 'cm', false, false),
        Getter.create(ReflectedType.create(int, 'int'), 'kg', false, false),
        Getter.create(ReflectedType.create(Map, 'Map<String, dynamic>'),
            'attributes__', false, false),
        Getter.create(
            ReflectedType.create(int, 'int'), 'hashCode', false, false)
  ...
  ReflectedClass(
      ...
      methods: [
        ...
        Method.create('/', ReflectedType.create(DRI, 'DRI'),
            MethodType.operator, false, null, false, null),
        Method.create('convertUnit', ReflectedType.create(null, 'void'),
            MethodType.normal, false, null, false, null),
...
List<EnumExtension> enumExtensions = [
  EnumExtension(
      name: 'MCFTypes',
      referenceType: ReflectedType.create(MCFTypes, "MCFTypes"),
      options: [
        'meal',
        'ingredient'
      ],
      methods: [
        Method.create("fromMap", ReflectedType.create(MCFTypes, "MCFTypes"),
            MethodType.factory, false, null, false, (Map map) {
          if (map['value'] == 'MCFTypes.meal') {
            return MCFTypes.meal;
          }
          if (map['value'] == 'MCFTypes.ingredient') {
            return MCFTypes.ingredient;
          }
          throw Exception("Enum MCFTypes can not instantiate from map $map");
        }),
      ]),
  EnumExtension(
