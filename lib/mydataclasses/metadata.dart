...
List<ReflectedClass> dataclasses = [
  ...
  ReflectedClass(
      ...
      getters: [
        Getter.create(
            ReflectedType.create(DRIS, 'DRIS'), 'dayDri', false, false),
      ...
      methods: [
        Method.create('createDay', ReflectedType.create(Day, 'Day'),
            MethodType.normal, false, null, false, null),
        Method.create('createMeal', ReflectedType.create(Meal, 'Meal'),
            MethodType.normal, false, null, false, null),
        Method.create(
            'createIngredient',
  ...
  ReflectedClass(
      ...
      attributes: [
        ...
        Attribute.create(
            ...
            false,
            null),
        Attribute.create('_singleton', ReflectedType.create(App, 'App'), true,
      ...
      methods: [
        Method.create(
            'returnsSingletonObject',
            ReflectedType.create(App, 'App'),
            MethodType.constructor,
            false,
            null,
            false,
            null),
        Method.create('_internal', ReflectedType.create(App, 'App'),
            MethodType.namedConstructor, false, null, false, null),
        Method.create('restart', ReflectedType.create(App, 'App'),
            MethodType.factory, false, null, false, App.restart),
        Method.create('update', ReflectedType.create(App, 'App'),
            MethodType.normal, false, null, false, null),
  ...
  ReflectedClass(
      ...
      methods: [
        Method.create('compare', ReflectedType.create(bool, 'bool'),
            MethodType.normal, false, null, false, null),
